...
export default function Home() {
  ...
  return <div className="site-shell">
    ...
    <main>
      ...
      <section id="contact" className="contact section-anchor"><div className="contact-visual"><div className="contact-grid" /><div className="contact-node node-one" /><div className="contact-node node-two" /><div className="contact-node node-three" /><span className="mono">PEOPLE + PROCESS + TECHNOLOGY</span></div><div className="contact-copy"><SectionLabel>04 / Open channel</SectionLabel><h2>Let’s talk about<br /><em>the work behind the work.</em></h2><p>I’m open to conversations about operations leadership, sales performance, quality systems, business development, and practical AI or automation opportunities.</p><div className="contact-actions"><a className="dark-button" href="#intro">Back to top <ArrowUpRight size={16} /></a><span className="contact-note mono">Public profiles</span></div><div className="social-links"><a href="https://www.linkedin.com/in/noel-amorcillo-jr-7456422b6/" target="_blank" rel="noreferrer">LinkedIn <ArrowUpRight size={14} /></a><a href="https://github.com/noelamorcillojr-create" target="_blank" rel="noreferrer">GitHub <ArrowUpRight size={14} /></a></div></div></section>
    </main>
